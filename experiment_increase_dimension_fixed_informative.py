...
def main():
    Experiment = namedtuple('Experiment', ['tag', 'simulator', 'kernel', 'dimensions', 'num_inducings', 'fix_dimension_at'])
    n = 801
    n_informative = 5

    experiments = [
        Experiment('linear_fixed_informative', LinearSimulator, GPy.kern.Linear, [5, 6, 7, 8, 9, 10, 15, 20],
                   [1, 2, 3, 4, 5, 10, 20, 50, 100, 200, 300, 400, n], fix_dimension_at=n_informative),
        # Experiment('friedman_fixed_informative', FriedMan1Simulator, GPy.kern.RBF, [5, 6, 7, 8, 9, 10, 15, 20],
        #            [1, 2, 3, 4, 5, 10, 20, 50, 100, 200, 300, 400, n], None)
    ]
